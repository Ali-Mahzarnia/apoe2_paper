...
data=read.csv('/Users/ali/Desktop/Jun23/apoe2_paper/divide_by_sum/multi_cca/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_sex/mikes_sex.csv')%>%select(Gene.Symbol, log2.FC., fdr_p)
data[2,1]
...
de$gene_symbol
result_path='/Users/ali/Desktop/Jun23/apoe2_paper/divide_by_sum/multi_cca/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_sex/RNA_result_ordered.xlsx'
library(xlsx)
...
ggsave("mcca_mike_sex.png", plot = final, 
       device='png', scale=1, width=12, height=10, unit=c("in"), dpi=200)




sum(de$log2FoldChange>0.6 & -log10(de$pvalue)>-log10(0.05))
sum(de$log2FoldChange<(-0.6) &  -log10(de$pvalue)>-log10(0.05))
