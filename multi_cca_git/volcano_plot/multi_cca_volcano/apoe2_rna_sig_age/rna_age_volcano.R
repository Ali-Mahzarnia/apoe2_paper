...
#data=read.csv('/Users/ali/Desktop/aug/volcano_plot/mikes_age.csv')%>%select(Gene.Symbol, log2.FC., ProbChiSq)
data=read.csv('/Users/ali/Desktop/Jun23/apoe2_paper/divide_by_sum/multi_cca/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_age/mikes_age.csv')%>%select(Gene.Symbol, log2.FC., fdr_p)
data[2,1]
...
library(xlsx)
de$gene_symbol
result_path='/Users/ali/Desktop/Jun23/apoe2_paper/divide_by_sum/multi_cca/volcano_plot/multi_cca_volcano/apoe2_mikes_sig_age/RNA_result_ordered.xlsx'
result=read.xlsx(result_path,sheetIndex = 1)
result$V1

de=subset(de, gene_symbol %in% result$V1)
...
ggsave("mcca_mike_age.png", plot = final, 
