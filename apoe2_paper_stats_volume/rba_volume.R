...
for (i in 1:length(file_list)) {
  ...
  # print( sum(temp$volume_mm3[2:len]))
  volumes[i,2:len]=temp$volume_mm3[2:len]/ sum(temp$volume_mm3[2:len])
 ...
 write.xlsx2(volumes, "volume_list.xlsx" )
...
write.xlsx2(table_age , "volume.xlsx", sheetName =  paste0("age"), append=TRUE )
...
write.xlsx2(table_sex , "volume.xlsx", sheetName =  paste0("Sex"), append=TRUE )
...
write.xlsx2(table_sex , "volume.xlsx", sheetName =  paste0("Age*Sex"), append=TRUE )
